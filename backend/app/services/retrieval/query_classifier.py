...
# Company overview must be checked BEFORE pricing, since "business" appears in both.
_RULES: list[tuple[re.Pattern, str]] = [
    # Company overview — vague "what do you do" queries (checked first to avoid
    # "tell me about your business" being caught by the pricing "business" keyword)
    (re.compile(
        # Dutch patterns
